...
where $V_{\lambda,k}^\text{max}$ is the unique maximal submodule of $V_{\lambda,k}$. {\color{red}It remains to show that the $F_{\lambda,k}$ have the requisite characters $\Phi_{\lambda,k}$.}
